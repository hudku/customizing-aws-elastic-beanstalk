...
#
# Deploys a new version of the application to the Elastic Beanstalk Development environment
#


$ELASTICBEANSTALK_APP_SCRIPT_DIR/deployment/staging-deploy-new-app.sh $ROUTE53_RR_DEVELOPMENT_NAME
